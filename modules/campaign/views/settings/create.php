...
<div class='admin-box'>
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		...
		<fieldset class='form-actions'>
			<input type='submit' name='save' class='btn btn-primary' value="<?php echo lang('campaign_action_create'); ?>" />
			<?php echo lang('bf_or'); ?>
			<?php echo anchor(SITE_AREA . '/settings/campaign', lang('campaign_cancel'), 'class="btn btn-warning"'); ?>
